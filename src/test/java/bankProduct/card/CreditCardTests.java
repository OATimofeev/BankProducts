...
public class CreditCardTests {
    ...
    @DisplayName("Проверка метода 'deposit'")
    @CsvSource(value = {
            "1000.22, 2000.22",
            "1.0, 1001.0"})
    ...
    @DisplayName("Проверка метода 'withdraw'")
    @CsvSource(value = {
            "1.22, 99.0",
            "10.0, 90.22"})
    ...
    @Test
    @DisplayName("Проверка метода 'checkBalance'")
    ...
    @ParameterizedTest(name = "deposit == {0}")
    @DisplayName("Проверка обработки исключений для невалидных значений в методе 'deposit'")
    ...
    @ParameterizedTest(name = "withdraw == {0}")
    @DisplayName("Проверка обработки исключений для невалидных значений в методе 'withdraw'")
    @MethodSource("debitCardWithdrawDepositNegativeTestsData")
